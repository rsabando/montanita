                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul id="nav">
                                    ...
                                    <li class="active"><a href="./apartamentos.php">Apartamentos</a></li>
            ...
            <div class="row h-100 align-items-end">
                <div class="col-12">
                    <div class="breadcrumb-content d-flex align-items-center justify-content-between pb-5">
                        <h2 class="room-title">Apartamentos</h2>
            ...
            <div class="row">
                <div class="col-12 col-lg-12">
                    ...
                    <div class="single-room-details-area mb-50">
                        ...
                        <p>Entre o mar ea floresta, uma colina é Montañita View, um hotel construído em harmonia com o meio ambiente, com grandes áreas verdes e zonas de relaxamento que fazem do hotel um lugar único e acolhedor.
O hotel tem 104 quartos I, divididas em 92 quartos e 12 padrão tipo loft. Cada quarto é espaçoso, confortável e confortáveis, alguns com jacuzzi, e duas camas pessoais ou uma rainha. Incluem serviços e equipamentos em geral que você esperaria de um hotel de alto fim. Todas as unidades têm vista e são cercados pela floresta mais pura e oceano de romper com a rotina ou simplesmente tratar-se de um tempo para se conectar com a natureza. Ao longo do ano tem bar, cafeteria e áreas de piscina.</p>
                    ...
                    <div class="room-service mb-50">
                        ...
                        <ul>
                            <li><img src="../img/core-img/icon1.png" alt=""> Ar-condicionado</li>
                            <li><img src="../img/core-img/icon2.png" alt=""> Bebidas</li>
                            <li><img src="../img/core-img/icon3.png" alt=""> Restaurante</li>
                            <li><img src="../img/core-img/icon4.png" alt=""> TV Cable</li>
                            <li><img src="../img/core-img/icon5.png" alt=""> Wifi</li>
                            <li><img src="../img/core-img/icon6.png" alt=""> serviço 24/7</li>
                        </ul>
                    </div>
