            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcrumb-content text-center">
                        <h2 class="page-title">Ônibus na Selva</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a href="index.php">Iniciar</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Ônibus na Selva</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6">
                    ...
                    <div class="section-heading wow fadeInUp" data-wow-delay="300ms">
                        ...
                        <h2>Ônibus na Selva</h2>
                    </div>
                    <div class="about-content mb-100 wow fadeInUp" data-wow-delay="500ms">
                        <p>O próximo nível de conforto se você precisa de uma pausa após um longo dia. Ele é projetado com grande atenção aos detalhes para o máximo conforto com estilo. Possui um terraço com vista panorâmica para o acesso ao mar, vip a todas as partes e área de co-working. Ele inclui uma cama confortável king size, pequeno-almoço buffet, assinatura de TV a cabo, internet, casa de banho privativa, cofre, mini-bar e produtos de higiene pessoal (toalhas, roupões e chinelos).</p>
                        <ul class="room-feature" data-animation="fadeInUp" data-delay="500ms">
                            <li><span><i class="fa fa-check"></i> Tamaño</span> <span>: 20 mt</span></li>
                            <li><span><i class="fa fa-check"></i> Capacidad</span> <span>: 2 personas</span></li>
                            <li><span><i class="fa fa-check"></i> Cama</span> <span>: King Beds</span></li>
                            <li><span><i class="fa fa-check"></i> Servicios</span> <span>: Wifi, Television, Baño</span></li>
                        </ul>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
            ...
            <div class="row h-100 align-items-center justify-content-center">
                <div class="col-12 col-md-6">
                    ...
                    <div class="section-heading text-center white wow fadeInUp" data-wow-delay="100ms">
                        <h6>Você quer conhecer o Ônibus na Selva?</h6>
                        <h2>Assista ao próximo vídeo</h2>
                    </div>
