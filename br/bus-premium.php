            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcrumb-content text-center">
                        <h2 class="page-title">Ônibus Prémio</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a href="index.php">Iniciar</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Ônibus Prémio</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6">
                    ...
                    <div class="about-content mb-100 wow fadeInUp" data-wow-delay="500ms">
                        <p>Este quarto se torna uma experiência total de viagem, incluindo um terraço com vista panorâmica para o mar e vip acesso a todas as partes. Ele inclui uma cama confortável king size, pequeno-almoço buffet, assinatura de TV a cabo, internet, casa de banho privativa, cofre, mini-bar e produtos de higiene pessoal (toalhas, roupões e chinelos).</p>
            ...
            <div class="row h-100 align-items-center justify-content-center">
                <div class="col-12 col-md-6">
                    ...
                    <div class="section-heading text-center white wow fadeInUp" data-wow-delay="100ms">
                        <h6>Você quer conhecer o Ônibus Prémio?</h6>
