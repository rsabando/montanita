                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul id="nav">
                                    ...
                                    <li class="active"><a href="./hoteles.php">Hotéis</a>
                                      <ul class="dropdown">
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcrumb-content text-center">
                        <h2 class="page-title">Rodoviária Orgânica</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a href="index.php">Iniciar</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Rodoviária Orgânica</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6">
                    ...
                    <div class="section-heading wow fadeInUp" data-wow-delay="300ms">
                        <h6>Estação Rodoviária Orgânica</h6>
                        <h2>Rodoviária Orgânica</h2>
                    </div>
                    <div class="about-content mb-100 wow fadeInUp" data-wow-delay="500ms">
                        <p>Viva uma experiência única em um ônibus condicionado ecológico com os melhores serviços de qualidade e acabamentos. Reconectar com a natureza em um lugar onde a paz ea harmonia com as prevalece ambiente.
Cada um dos ônibus tem dois quartos, casa de banho privativa e um terraço com vista privilegiada de uma das melhores praias da América Latina. Local privado é o que realmente distingue os nossos integra arquitetura proposta perfeitamente com o ambiente natural.</p>
