...
<body>
    ...
    <div class="breadcrumb-area bg-img bg-overlay jarallax" style="background-image: url(../img/buseco3.png);">
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcrumb-content text-center">
                        <h2 class="page-title">Jungle Bus</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Jungle Bus</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6">
                    ...
                    <div class="section-heading wow fadeInUp" data-wow-delay="300ms">
                        <!-- <h6>Estacion de Buses Ecológicos</h6> -->
                        <h2>Jungle Bus</h2>
                    </div>
                    <div class="about-content mb-100 wow fadeInUp" data-wow-delay="500ms">
                        <p>The next level of comfort if you need a break after a long day. It is designed with great attention to detail for maximum comfort with style. It features a terrace with panoramic views of the sea, vip access to all parties and co-working area. It includes a comfortable king size bed, buffet breakfast, cable TV subscription, internet, private bathroom, safe, minibar and toiletries (towels, robes and slippers).</p>
                        <ul class="room-feature" data-animation="fadeInUp" data-delay="500ms">
                            <li><span><i class="fa fa-check"></i> Size</span> <span>: 20 mt</span></li>
                            <li><span><i class="fa fa-check"></i> Capacity</span> <span>: 2 persons</span></li>
                ...
                <div class="col-12 col-lg-6">
                    <div class="about-thumbnail pr-lg-5 mb-100 wow fadeInLeft" data-wow-delay="100ms">
                        <img src="../img/suits/8.jpeg" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Video Area Start -->
    <div class="roberto--video--area bg-img bg-overlay jarallax section-padding-0-100" style="background-image: url(../img/buseco2.png);">
        <div class="container h-100">
            <div class="row h-100 align-items-center justify-content-center">
                <div class="col-12 col-md-6">
                    <!-- Section Heading -->
                    <div class="section-heading text-center white wow fadeInUp" data-wow-delay="100ms">
                        <h6>Do you want to know the Jungle bus?</h6>
                        <h2>Watch the next video</h2>
                    </div>
                    <div class="video-content-area mt-100 wow fadeInUp" data-wow-delay="500ms">
                        <a href="../img/video/buseco.mp4" class="video-play-btn"><i class="fa fa-play"></i></a>
                    </div>
                </div>
            </div>
        </div>
