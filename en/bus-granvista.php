            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcrumb-content text-center">
                        <h2 class="page-title">Bus Great View</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Bus Great View</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6">
                    ...
                    <div class="section-heading wow fadeInUp" data-wow-delay="300ms">
                        ...
                        <h2>Bus Great View</h2>
                    </div>
                    <div class="about-content mb-100 wow fadeInUp" data-wow-delay="500ms">
                        <p>This includes room a privileged view of the beautiful shores of the sea and is equipped with a comfortable king size bed, Buffet breakfast, TV with premium cable, internet, private bathroom, safe, terrace and toiletries (towels, bathrobes and slippers).</p>
                        <ul class="room-feature" data-animation="fadeInUp" data-delay="500ms">
                            ...
                            <li><span><i class="fa fa-check"></i> Services</span> <span>: Wifi, Television, Bethroom</span></li>
                        </ul>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
                    <div class="about-thumbnail pr-lg-5 mb-100 wow fadeInLeft" data-wow-delay="100ms">
                        <img src="../img/suits/6.jpeg" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row h-100 align-items-center justify-content-center">
                <div class="col-12 col-md-6">
                    ...
                    <div class="section-heading text-center white wow fadeInUp" data-wow-delay="100ms">
                        <h6>Do you want to know the Great View bus?</h6>
