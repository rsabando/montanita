            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcrumb-content text-center">
                        <h2 class="page-title">Premium Bus</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Premium Bus</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6">
                    ...
                    <div class="about-content mb-100 wow fadeInUp" data-wow-delay="500ms">
                        <p>This room becomes a total travel experience including a terrace with panoramic views of the sea and vip access to all parties. It includes a comfortable king size bed, buffet breakfast, cable TV subscription, internet, private bathroom, safe, minibar and toiletries (towels, robes and slippers).</p>
            ...
            <div class="row h-100 align-items-center justify-content-center">
                <div class="col-12 col-md-6">
                    ...
                    <div class="section-heading text-center white wow fadeInUp" data-wow-delay="100ms">
                        <h6>Do you want to know the Premium bus?</h6>
