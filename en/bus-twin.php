            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcrumb-content text-center">
                        <h2 class="page-title">Bus Aventura Twin</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Bus Aventura Twin</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6">
                    ...
                    <div class="section-heading wow fadeInUp" data-wow-delay="300ms">
                        ...
                        <h2>Bus Aventura Twin</h2>
                    </div>
                    <div class="about-content mb-100 wow fadeInUp" data-wow-delay="500ms">
                        <p>This room consists of two twin comfortable beds, air conditioning, cable TV subscription, internet, private bathroom, a safe and a terrace with panoramic views of the sea.</p>
                        <ul class="room-feature" data-animation="fadeInUp" data-delay="500ms">
                            <li><span><i class="fa fa-check"></i> Size</span> <span>: 20 mt</span></li>
                            <li><span><i class="fa fa-check"></i> Capacity</span> <span>: 2 personas</span></li>
                            <li><span><i class="fa fa-check"></i> Bed</span> <span>: King Beds</span></li>
                            <li><span><i class="fa fa-check"></i> Service</span> <span>: Wifi, Television, bathroom</span></li>
                        </ul>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
                    <div class="about-thumbnail pr-lg-5 mb-100 wow fadeInLeft" data-wow-delay="100ms">
                        <img src="../img/suits/5.jpeg" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row h-100 align-items-center justify-content-center">
                <div class="col-12 col-md-6">
                    ...
                    <div class="section-heading text-center white wow fadeInUp" data-wow-delay="100ms">
                        <h6>Do you want to know the Twin bus?</h6>
