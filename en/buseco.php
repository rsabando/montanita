            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcrumb-content text-center">
                        <h2 class="page-title">Organic Bus</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Organic Bus</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6">
                    ...
                    <div class="section-heading wow fadeInUp" data-wow-delay="300ms">
                        <h6>Organic Bus Station</h6>
                        <h2>Organic Bus</h2>
                    </div>
                    <div class="about-content mb-100 wow fadeInUp" data-wow-delay="500ms">
                        <p>Live a unique experience in an ecological bus conditioning with the best quality services and finishes. Reconnect with nature in a place where peace and harmony are present with the environment prevails.
Each of the buses has two bedrooms, private bath, and a terrace with privileged view of one of the best beaches in Latin America. Private location is what really distinguishes our proposal architecture integrates seamlessly with the natural environment.</p>
                        <!-- <img src="img/core-img/signature.png" alt=""> -->
                    </div>
                </div>
                <div class="col-12 col-lg-6">
                    <div class="about-thumbnail pr-lg-5 mb-100 wow fadeInLeft" data-wow-delay="100ms">
                        <img src="../img/buseco.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row h-100 align-items-center justify-content-center">
                <div class="col-12 col-md-6">
                    ...
                    <div class="section-heading text-center white wow fadeInUp" data-wow-delay="100ms">
                        <h6>Do you want to know the Organic Bus?</h6>
