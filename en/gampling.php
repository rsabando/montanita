...
<body>
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul id="nav">
                                    ...
                                    <li class="active"><a href="./hoteles.php">hoteles</a>
                                      <ul class="dropdown">
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcrumb-content text-center">
                        <h2 class="page-title">Gambling</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Gambling</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <div class="section-heading wow fadeInUp" data-wow-delay="300ms">
                        <h6>Hotel Gambling</h6>
                        <h2>Gambling</h2>
                    </div>
                    <div class="about-content mb-100 wow fadeInUp" data-wow-delay="500ms">
                        <p>View Montanita perfectly combines the height of luxury and inherent tranquility of nature. It has rooms with all the amenities you'd expect from a high end hotel. You can enjoy a rustic atmosphere while you sleep comfortable bed and fully equipped with panoramic views of breathtaking scenery or the sea.</p>
    ...
    <!-- Video Area Start -->
    <div class="roberto--video--area bg-img bg-overlay jarallax section-padding-0-100" style="background-image: url(../img/bg-img/39.jpg);">
        <div class="container h-100">
