...
<body>
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul id="nav">
                                    ...
                                    <li class="active"><a href="./hoteles.php">Hotels</a>
                                      <ul class="dropdown">
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcrumb-content text-center">
                        <h2 class="page-title">Sponge Bob Hotel</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Sponge Bob Hotel</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <div class="section-heading wow fadeInUp" data-wow-delay="300ms">
                        <h6>Theme Hotel</h6>
                        <h2>Sponge Bob Theme Hotel</h2>
                    </div>
                    <div class="about-content mb-100 wow fadeInUp" data-wow-delay="500ms">
                        <p>This accommodation features themed rooms that pay homage to the world of SpongeBob. Living in the home of the most iconic characters of Bikini Bottom in a pineapple under the sea, in an MAOI or under a large rock You decide!.</p>
                        <p>Each room has similar features of the home of each of our characters with modern and luxurious amenities with the unique experience of instantly transport you into the world of SpongeBob. This accommodation is equipped with double bed or two single beds option, including quality finishes and services including transport to the hotel, breakfast, and accessories such as slippers and robes.</p>
    ...
    <!-- Video Area Start -->
    <div class="roberto--video--area bg-img bg-overlay jarallax section-padding-0-100" style="background-image: url(../img/bg-img/28.jpg);">
        <div class="container h-100">
            <div class="row h-100 align-items-center justify-content-center">
                <div class="col-12 col-md-6">
                    <!-- Section Heading -->
                    <div class="section-heading text-center white wow fadeInUp" data-wow-delay="100ms">
                        <h6>Do you want to know the Hotel?</h6>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="section-heading text-center wow fadeInUp" data-wow-delay="100ms">
                        <h6>Sponge Bob Hotel</h6>
                        <h2>Services y Areas</h2>
                    </div>
                </div>
            </div>
