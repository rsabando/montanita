                ...
                <div class="col-12 col-lg-12">
                    ...
                    <div class="single-room-area d-flex align-items-center mb-50 wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <div class="room-content">
                            <h2>Sponge Bob Hotel</h2>
                            <h4>400$ <span>/ Day</span></h4>
                            <div class="room-feature">
                                <h6>Size: <span>40 mt</span></h6>
                                <h6>Capacity: <span>5 persons Max</span></h6>
                                <!-- <h6>Bed: <span>King beds</span></h6> -->
                                <h6>Services: <span>Wifi, tv, breakfast</span></h6>
                            </div>
                            <a href="hotelbob.php" class="btn view-detail-btn">see Hotel <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                        </div>
                    </div>
