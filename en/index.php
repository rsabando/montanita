...
<body>
  ...
  <div class="section-heading wow fadeInUp" data-wow-delay="100ms">
      <h2 id="b-letra">Welcome to Montañita View</h2>
            <h6 id="l-reserva">Book now</h6>
                            ...
                            <div class="row justify-content-center">
                              ...
                              <div class="col-4 col-md-2 col-lg-1">
                                ...
                                <div class="btn-reservar">
                                  <button type="submit" class="form-control btn roberto-btn w-100">Book</button>
                                </div>
                            </div>
                        </form>
                    </div> -->
            ...
            <div class="row align-items-center">
                <div class="col- col-lg-6">
                    ...
                    <div class="section-heading wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <h2 id="titulo-video">Welcome to Montañita View</h2>
                    </div>
                    <div class="about-us-content mb-100">
                        <h5 class="wow fadeInUp" data-wow-delay="300ms">We are a unique tourist complex in Ecuador that seeks to create a different concept framed in experiences. We offer our clients a wide variety of services that range from thematic hotels, ecological bus station with panoramic sea view, gampling that combine luxury and outdoor adventure, to the most modern in a hotel complex with first class infrastructure that They include a pool, bars, and common social and recreational areas.</h5>
    ...
    <section class="roberto-rooms-area">
        <div class="rooms-slides owl-carousel">
          <div class="single-room-slide d-flex align-items-center">
            ...
            <div class="bannerroom" style="background-image: url(../img/suits/1.jpeg); background-size:cover; ">
              <div class="room-content">
                    <a href="bus-aventura.php"><h2 data-animation="fadeInUp" data-delay="100ms">Bus Adventure</h2></a>
          ...
          <div class="single-room-slide d-flex align-items-center">
              ...
              <div class="room-content">
                <a href="bus-granvista.php"><h2 data-animation="fadeInUp" data-delay="100ms">Bus Great View</h2></a>

                  <br>
                  <h3 data-animation="fadeInUp" data-delay="300ms">325$ <span>/ Day</span></h3>
              </div>
                </div>
          </div>
  ...
  <div class="bannerroom" style="background-image: url(../img/suits/3.jpeg);background-size:cover;">
              <div class="room-content">
                <a href="bus-premium.php"><h2 data-animation="fadeInUp" data-delay="100ms">Premium Bus</h2></a>
  ...
  <div class="bannerroom" style="background-image: url(../img/suits/4.jpeg);background-size:cover;">
              <div class="room-content">
                <a href="bus-delaselva.php"><h2 data-animation="fadeInUp" data-delay="100ms">Jungle Bus</h2></a>
                            ...
                            <div class="gallery-cell">
                                <div class="comment-content d-flex justify-content-center">
                                    ...
                                    <div class="comment-meta">
                                        ...
                                        <h5>Luis Gonzalo</h5>
                                        <p>Great hotel with a beautiful view.</p>
                                ...
                                <div class="comment-content d-flex justify-content-center">
                                    ...
                                    <div class="comment-meta">
                                        ...
                                        <p>Excellent breakfast and very varied</p>
                                ...
                                <div class="gallery-cell">
                                  <div class="comment-content d-flex justify-content-center">
                                      ...
                                      <div class="comment-meta">
                                          <a href="#" class="post-date">5 Ene 2020</a>
                                          <h5>Cindy Moran</h5>
                                          <p>Thanks for an excellent holiday</p>
                                  ...
                                  <div class="gallery-cell">
                                    <div class="comment-content d-flex justify-content-center">
                                        ...
                                        <div class="comment-meta">
                                            <a href="#" class="post-date">5 Ene 2020</a>
                                            <h5>Mario Villa</h5>
                                            <p>I will definitely return, the best hotel in Ecuador.</p>
...
All Rights Reserved grupo3i.com &copy;<script>document.write(new Date().getFullYear());</script> <a href="https://colorlib.com" target="_blank"></a>
...
<div class="politicas">
  <a  target="_blank" href="politicas.php">Policies and Privacy</a>
