            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcrumb-content text-center">
                        <h2 class="page-title">Bus de la Selva</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a href="index.php">Inicio</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Bus de la Selva</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6">
                    ...
                    <div class="section-heading wow fadeInUp" data-wow-delay="300ms">
                        ...
                        <h2>Bus de la Selva</h2>
                    </div>
                    <div class="about-content mb-100 wow fadeInUp" data-wow-delay="500ms">
                        <p>El siguiente nivel de comodidad si necesitas un descanso después de un largo día. Está diseñada con gran atención a los detalles para un máximo confort con estilo. Cuenta con una terraza con vista panorámica al mar, acceso vip a todas las fiestas y área de co-working. Incluye una confortable cama King Size, desayuno buffet, TV con suscripción por cable, internet, baño privado, una caja fuerte, frigobar y artículos de aseo (toallas, batas y pantunflas).</p>
            ...
            <div class="row h-100 align-items-center justify-content-center">
                <div class="col-12 col-md-6">
                    ...
                    <div class="section-heading text-center white wow fadeInUp" data-wow-delay="100ms">
                        <h6>¿Quieres conocer el bus de la Selva?</h6>
                        <h2>Mira el siguiente video</h2>
                    </div>
