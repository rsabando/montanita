            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6">
                    ...
                    <div class="about-content mb-100 wow fadeInUp" data-wow-delay="500ms">
                        <p>Esta habitación está compuesta por dos cómodas camas twin, aire acondicionado, TV con suscripción por cable, internet, baño privado, una caja fuerte y una terraza con vista panorámica al mar.</p>
            ...
            <div class="row h-100 align-items-center justify-content-center">
                <div class="col-12 col-md-6">
                    ...
                    <div class="section-heading text-center white wow fadeInUp" data-wow-delay="100ms">
                        <h6>¿Quieres conocer el bus Twin</h6>
