            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcrumb-content text-center">
                        <h2 class="page-title">Bus Ecológico</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a href="index.php">Inicio</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Bus Ecológico</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6">
                    ...
                    <div class="about-content mb-100 wow fadeInUp" data-wow-delay="500ms">
                        <p>Vive una experiencia única en un bus ecológico acondicionado con los mejores servicios en calidad y acabados. Reconéctate con la naturaleza en un lugar donde predomina la paz y la armonía con el medio ambiente.
Cada uno de los buses cuenta con dos dormitorios, baño privado, y una terraza con vista privilegiada a una de las mejores playas de Latinoamérica. Es la ubicación privada lo que realmente nos distingue, nuestra propuesta arquitectónica se integra a la perfección con el entorno natural.</p>
            ...
            <div class="row h-100 align-items-center justify-content-center">
                <div class="col-12 col-md-6">
                    ...
                    <div class="section-heading text-center white wow fadeInUp" data-wow-delay="100ms">
                        <h6>¿Quieres conocer el bus Ecoloógico?</h6>
