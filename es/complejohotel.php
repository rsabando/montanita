            ...
            <div class="row h-100 align-items-end">
                <div class="col-12">
                    <div class="breadcrumb-content d-flex align-items-center justify-content-between pb-5">
                        <h2 class="room-title">Hotel Montañita View</h2>
            ...
            <div class="row">
                <div class="col-12 col-lg-12">
                    ...
                    <div class="single-room-details-area mb-50">
                        ...
                        <p>Entre el mar y bosque, arriba de una colina se encuentra Montañita View, un hotel construido en armonía con el entorno, con amplias áreas verdes y zonas de relax que hacen del hotel un lugar único y acogedor.</p>
                        <p>El hotel cuenta con 104 habitaciones, dividido en 92 habitaciones de tipo estándar y 12 de tipo loft. Cada habitación es amplia, cómoda y confortable, algunas con hidromasaje, y con dos camas personales o una matrimonial. Incluyen los servicios y equipamientos generales que esperarías de un hotel de alta gama. Todas las unidades cuentan con vista y están rodeadas del más puro bosque y océano para descansar de la rutina o simplemente regalarse un tiempo de conectarse con la naturaleza. Durante todo el año cuenta con bar, cafetería, áreas sociales y piscinas.</p>
                    ...
                    <div class="room-service mb-50">
                        ...
                        <ul>
                            <li><img src="../img/core-img/icon1.png" alt=""> Aire Acondicionado</li>
                            ...
                            <li><img src="../img/core-img/icon6.png" alt=""> Servicio 24/24</li>
                        </ul>
                    </div>
