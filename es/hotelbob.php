            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcrumb-content text-center">
                        <h2 class="page-title">Hotel Bob Esponja</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a href="index.php">Inicio</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Hotel Bob Esponja</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <div class="section-heading wow fadeInUp" data-wow-delay="300ms">
                        <h6>Hotel Temático</h6>
                        <h2>Hotel Temático Bob Esponja</h2>
                    </div>
                    <div class="about-content mb-100 wow fadeInUp" data-wow-delay="500ms">
                        <p>Este alojamiento cuenta con habitaciones temáticas que rinden homenaje al mundo de Bob Esponja. Vive en el hogar de los personajes más icónicos de Fondo de Bikini, en una piña debajo del mar, en un Maoi o debajo de una gran roca ¡Tú decides!.</p>
                        <p>Cada habitación cuenta con las características similares del hogar de cada uno de nuestros personajes con todas las comodidades modernas y lujosas con la experiencia única de transportarte instantáneamente en el mundo de Bob Esponja. Este alojamiento está equipado con cama doble o la opción de dos camas singles, incluyendo acabados de primera calidad, así como servicios incluidos de transporte al hotel, desayuno, y accesorios como pantuflas y batas.</p>
            ...
            <div class="row h-100 align-items-center justify-content-center">
                <div class="col-12 col-md-6">
                    ...
                    <div class="section-heading text-center white wow fadeInUp" data-wow-delay="100ms">
                        <h6>¿Quieres conocer el hotel?</h6>
